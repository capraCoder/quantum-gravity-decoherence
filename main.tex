...
Consider a pendulum on a rotating platform, viewed by cameras at different angles. A camera aligned with the rotation axis cannot see axial displacement; a camera perpendicular to it sees full displacement. The pendulum's motion does not change. What the camera records does---because the measurement axis determines which component of motion appears in the data.
